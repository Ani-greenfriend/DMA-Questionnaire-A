...
export default function ParticipantExperience({
  ...
  if (phase === 'welcome') {
    ...
    content = <Submit comment={comment} setComment={setComment} onSubmit={() => { onSubmit(answers, relevantIros, stakeholder, comment); setPhase('done'); }} />;
  }
